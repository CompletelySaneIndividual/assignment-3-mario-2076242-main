...
export default class Player extends Entity {
	...
	constructor(dimensions, position, velocityLimit, level) {
		...
		this.otherSprites = Player.generateBigSprites();
	...
	grow(){
		if(this.size == 0){
			...
			let tmp = this.sprites;
			this.sprites = this.otherSprites;
			this.otherSprites = tmp;
		}else{
	...
	shrink(entity){		
			...
			entity.changeState(SnailStateName.Dying);
			entity.isDead = true;		
	}
}
