...
export default class LevelMaker {
	...
	static PLAYER_SPAWN_LOCATION = 1;
	...
	static generateLevel(width = LevelMaker.DEFAULT_LEVEL_WIDTH, height = LevelMaker.DEFAULT_LEVEL_HEIGHT) {
		...
		for (let x = 0; x < width; x++) {
			...
			if (chasmCounter > 0 && x != LevelMaker.PLAYER_SPAWN_LOCATION && x != LevelMaker.DEFAULT_LEVEL_WIDTH-2) {//making sure there is space for both player and flagpole
				continue;
			}
